...
def sync_detailed(
    *,
    ...
    """Get Unique Sites Endpoint

     Return all unique extracted_from_site values that have data in the given time range.
    ...
    Args:
        ...
        use_extracted_date (bool | Unset): If True, filter by extracted_date; if False, filter by
