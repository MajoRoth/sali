...
T = TypeVar("T", bound="GetStoresResponse")
...
class GetStoresResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for stores_item_data in _stores:
            stores_item = Store.from_dict(stores_item_data)

            stores.append(stores_item)

        get_stores_response = cls(
            stores=stores,
        )

        get_stores_response.additional_properties = d
        return get_stores_response
